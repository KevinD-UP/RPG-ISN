...
def export_map(file):
    ...
    for tile in tile_data:
        map_data = map_data + str(float(tile[0] / Tiles.Size)) + "," + str(float(tile[1] / Tiles.Size)) + ":" + tile[2] + "-"
        

    # Save Map Dimensions
    map_data = map_data + str(float(max_x / Tiles.Size)) + "," + str(float(max_y / Tiles.Size))
...
def load_map(file):
    ...
    map_size[0] = float(map_size[0]) * Tiles.Size
    map_size[1] = float(map_size[1]) * Tiles.Size
